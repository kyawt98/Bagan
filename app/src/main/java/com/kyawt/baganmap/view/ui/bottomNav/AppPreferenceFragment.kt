...
import kotlinx.android.synthetic.main.fragment_app_preference.*
...
class AppPreferenceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_app_preference, container, false)
    }
    ...
    private fun onBackPressed() {
        icBack.setOnClickListener {
            findNavController().navigate(
                R.id.action_appPreferenceFragment_to_settingFragment,
                null,
                navOptions()
            )
        }
